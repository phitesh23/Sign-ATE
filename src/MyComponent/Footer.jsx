    ...
    <div className="footer-wrapper py-4 container text-center text-md-left">
      <div className="row">
        <div className="col-md-6 mt-md-0 mt-3">
          ...
          <p>
            The Email Signature Generator is Designed by Hitesh Kumar Pathak it is a tool designed to help Students, Faculty, & Staff Members to create professional email signatures. It allows you to enter your name, department, section, phone number, email, and professional profiles to generate a personalized email signature that you can use in your communications.
          </p>
        </div>
